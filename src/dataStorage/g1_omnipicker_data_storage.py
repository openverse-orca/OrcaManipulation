...
class G1OmniPickerDataStorage(AbstractDataStorage):
    ...
    def obs_callback(self, env: OrcaGymLocalEnv) -> dict:
        obs = {}
        joint_names = g1_omnipicker_conf.l_arm["joint_names"] + g1_omnipicker_conf.r_arm["joint_names"]
        joint_names = [env.joint(joint_name) for joint_name in joint_names]

        hand_names = g1_omnipicker_conf.gripper_l["joint_names"] + g1_omnipicker_conf.gripper_r["joint_names"]
        hand_names = [env.joint(hand_name) for hand_name in hand_names]

        hand_motor_names = g1_omnipicker_conf.gripper_l["actuator_names"] + g1_omnipicker_conf.gripper_r["actuator_names"]
        ...
        arm_motor_names = g1_omnipicker_conf.l_arm["motors_names"] + g1_omnipicker_conf.r_arm["motors_names"]
        ...
        ee_site_names = [g1_omnipicker_conf.l_arm["ee_site_name"], g1_omnipicker_conf.r_arm["ee_site_name"]]
        ...
        ee_site_pos_quat = env.query_site_pos_and_quat_B(ee_site_names, [env.body(g1_omnipicker_conf.base_body)])
