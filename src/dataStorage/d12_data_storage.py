...
class D12DataStorage(AbstractDataStorage):
    ...
    def obs_callback(self, env: OrcaGymLocalEnv) -> dict:
        ...
        gripper_names = d12_conf.gripper_l["joint_names"] + d12_conf.gripper_r["joint_names"]
        gripper_names = [env.joint(gripper_name) for gripper_name in gripper_names]

        gripper_motor_names = d12_conf.gripper_l["actuator_names"] + d12_conf.gripper_r["actuator_names"]
