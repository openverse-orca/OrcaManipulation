l_arm = {
    ...
    # "positions_names": [
    #     "idx21_arm_l_joint1_pctrl",
    #     "idx22_arm_l_joint2_pctrl",
    #     "idx23_arm_l_joint3_pctrl",
    #     "idx24_arm_l_joint4_pctrl",
    #     "idx25_arm_l_joint5_pctrl",
    #     "idx26_arm_l_joint6_pctrl",
    #     "idx27_arm_l_joint7_pctrl",
    # ],
...
r_arm = {
    ...
    # "positions_names": [
    #     "idx61_arm_r_joint1_pctrl",
    #     "idx62_arm_r_joint2_pctrl",
    #     "idx63_arm_r_joint3_pctrl",
    #     "idx64_arm_r_joint4_pctrl",
    #     "idx65_arm_r_joint5_pctrl",
    #     "idx66_arm_r_joint6_pctrl",
    #     "idx67_arm_r_joint7_pctrl",
    # ],
    # "positions_init_ctrl": [1.42, -0.88, -1.54, 1.48, 0, 0, 0],
    # "positions_ranges": [
    #     (-3.14, 3.14),
