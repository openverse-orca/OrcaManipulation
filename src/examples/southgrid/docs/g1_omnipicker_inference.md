...
本文说明按钮/工具任务的 OpenPI 在线推理。通用接口见 [policy_inference.md](../../../../docs/policy_inference.md) 与 [openpi_deployment.md](../../../../docs/openpi_deployment.md)。数据采集见 [g1_omnipicker_collection.md](g1_omnipicker_collection.md)。
...
| 参数 | 说明 | 默认值 |
|---|---|---|
| `--task_config` | 任务配置文件路径 | `../../configs/example.yaml` |
