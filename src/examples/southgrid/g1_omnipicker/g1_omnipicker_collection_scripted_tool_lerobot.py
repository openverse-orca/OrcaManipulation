...
def main():
    ...
    parser.add_argument("--task", default="整理工具")
    parser.add_argument(
        "--tool_body",
        default="Group_Interactive_Screwdriver_task_screwdriver_joint",
    )
    ...
    def prepare_episode():
        ...
        manager.set_device(
            ScriptedTrajectoryDevice(
                l_arm, r_arm, l_grip, r_grip, task_status, *traj, grasp_binder=grasp_binder
            )
        )
